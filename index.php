...
<main class="pws-wrap">
  ...
  <?php else: ?>
    <p class="pws-count"><?= count($forms) ?> form<?= count($forms) === 1 ? '' : 's' ?></p>
    <ul class="pws-list">
  ...
  <p class="pws-note">
    This list is generated by scanning for folders containing an <code>index.php</code>
    with a <code>PWS_FORM_SLUG</code> constant &mdash; new forms show up on their own.
    Remember to add the slug to <code>PWS_ALLOWED_FORMS</code> in
    <code>rsvp-core/config.php</code>, or submissions will be rejected.
  </p>
</main>
